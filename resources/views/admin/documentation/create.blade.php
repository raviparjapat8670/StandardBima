...
<div class="page-title">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
            <form class="form-label-left input_mask" method="POST" action="{{ route('admin.add-documentation') }}">
                @csrf <!-- CSRF token for security -->
                <div class="col-md-12 col-sm-12  form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="name" placeholder="Name">
...
<div class="form-group col-md-6 col-sm-6 ">
                ...
                <div class="form-group row">
                    <div class="col-md-9 col-sm-9  offset-md-3">
                        <a href="{{route('admin.occupations')}}" type="button" class="btn btn-primary">Cancel</a>

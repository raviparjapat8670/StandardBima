...
<div class="page-title">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
            <form class="form-label-left input_mask" method="POST" action="{{ route('admin.add-occupation') }}">
                @csrf <!-- CSRF token for security -->
                <div class="col-md-6 col-sm-6  form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="title" placeholder="Title">
